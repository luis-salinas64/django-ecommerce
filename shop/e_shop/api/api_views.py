...
from e_shop.api.serializers import *
...
class GetArticuloAPIView(ListAPIView):
    __doc__ = f'''{mensaje_headder}
    `[METODO GET]`
    Esta vista de API nos devuelve una lista de todos los articulos presentes en la base de datos.
    '''
...
class PostArticuloAPIView(CreateAPIView):
    __doc__ = f'''{mensaje_headder}
    `[METODO POST]`
...
class ListCreateArticuloAPIView(ListCreateAPIView):
    __doc__ = f'''{mensaje_headder}
    `[METODO GET-POST]`
    Esta vista de API nos devuelve una lista de todos los articulos presentes en la base de datos.
...
class RetrieveUpdateArticuloAPIView(RetrieveUpdateAPIView):
    __doc__ = f'''{mensaje_headder}
...
class DestroyArticuloAPIView(DestroyAPIView):
    __doc__ = f'''{mensaje_headder}
    `[METODO DELETE]`
